...
2. Open the `led_blink.ino` file in the Arduino IDE.
3. Select the correct board (Arduino Uno) and port under the **Tools** menu.
4. Click the **Upload** button to transfer the code to your board.
